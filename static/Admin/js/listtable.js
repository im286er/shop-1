...
/* ECS--->TP miaomin edited by 2012/10/9
...
//listTable.url = location.href.substring(0,location.href.lastIndexOf("/"));
listTable.url = URL;
listTable.url += "/ajax";
...
listTable.toggle = function(obj, act, id)
{
  ...
  if (res.error == 0)
  {
	obj.src = (res.content > 0) ? PUBLIC+'/Admin/images/yes.gif' : PUBLIC+'/Admin/images/no.gif';
  }
}
