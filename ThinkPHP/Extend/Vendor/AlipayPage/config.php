...
//开发者公钥
//MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDiXfJuXdocJXIWI4fcwYVJnec7o+W2SKJXbqBDJ+YddymbtbYdPOa9maBJfgkvVeq5IkYMTCp7QRJWOZM6j1+lsD5YL5+VDOf4Whob0+u1LrDqg5K5qLjDticRt4rPz7KTMWRiLFBPPZXsWCdXWgU1kkag7TUBlPN9FxFJdHXsHwIDAQAB
...
//    $alipay_config['notify_url'] = "http://www.ignjewelry.com/alipay.wap.create.direct.pay.by.user-PHPUTF-8/notify_url.php";
    $alipay_config['notify_url'] = "http://www.ignjewelry.com/user.php/Orderpage/returnurl";
// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
//    $alipay_config['return_url'] = "http://www.ignjewelry.com/alipay.wap.create.direct.pay.by.user-PHP-UTF-8/return_url.php";
