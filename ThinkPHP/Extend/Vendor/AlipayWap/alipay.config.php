...
$alipay_config['notify_url'] = "http://192.168.52.19/alipay.wap.create.direct.pay.by.user-PHPUTF-8/notify_url.php";

// 页面跳转同步通知页面路径 需http://格式的完整路径，不能加?id=123这类自定义参数，必须外网可以正常访问
$alipay_config['return_url'] = "http://192.168.52.19/alipay.wap.create.direct.pay.by.user-PHP-UTF-8/return_url.php";
